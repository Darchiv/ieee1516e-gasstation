...
import Vehicle.VehicleFederate;

/**
 * This class handles all incoming callbacks from the RTI regarding a particular
 * {@link VehicleFederate}. It will log information about any callbacks it
 * receives, thus demonstrating how to deal with the provided callback information.
 */
public class VehicleFederateAmbassador extends NullFederateAmbassador
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public void announceSynchronizationPoint( String label, byte[] tag )
	{
		...
		if( label.equals(VehicleFederate.READY_TO_RUN) )
