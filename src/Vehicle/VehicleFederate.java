...
import Vehicle.VehicleFederateAmbassador;
...
public class VehicleFederate
{
	...
	private VehicleFederateAmbassador fedamb;  // created when we connect
	...
	public void runFederate( String federateName ) throws Exception
	{
		...
		// connect
		log( "Connecting..." );
		fedamb = new VehicleFederateAmbassador( this );
	...
	public static void main( String[] args )
	{
		...
		try
		{
			...
			new VehicleFederate().runFederate( federateName );
		}
